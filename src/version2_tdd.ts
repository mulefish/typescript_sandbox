...
function testAllInterfaces() {
    ...
    const categoryPageViewExample: CategoryPageView = {
        // TypeLocaleLanguage properties
        locale: "en-US",
        language: "English",
    ...
    const checkoutPaymentPageViewExample: CheckoutPaymentPageView = {
        // TypeProduct properties
        productId: "78910",
    ...
    const checkoutPurchaseCompletePageViewExample: CheckoutPurchaseCompletePageView = {
        // TypeProduct properties
        productId: "32109",
    ...
    const checkoutShippingPageViewExample: CheckoutShippingPageView = {
        productId: "65432",
    ...
    const exitLinkClickExample: ExitLinkClick = {
        locale: "en-US",
        language: "English",
    ...
    const homePageViewExample: HomePageView = {
        locale: "en-US",
        language: "English",
        pageName: "Home",
    ...
    const orderReviewPageViewExample: OrderReviewPageView = {
        productId: "98765",
    ...
    const pageViewExample: PageView = {
        locale: "en-US",
        language: "English",
        pageName: "About Us",
    ...
    const productDetailPageViewExample: ProductDetailPageView = {
        productId: "123456",
    ...
    const purchaseExample: Purchase = {
        // TypeLocaleLanguage properties
        locale: "en-US",
        language: "English",
    ...
    const removeFromCartExample: RemoveFromCart = {
        productId: "654321",
    ...
    const searchResultsPageViewExample: SearchResultsPageView = {
        // TypeLocaleLanguage properties
        locale: "en-US",
        language: "English",
    ...
    const searchResultsClickExample: SearchResultsClick = {
        // TypeSearch properties
    ...
    const componentImpressionExample: ComponentImpression = {
        // TypePageName properties
    ...
    const emailSignupSuccessExample: EmailSignupSuccess = {
        // TypeUserId properties
        userId: "user123456",
    ...
    const faqClickExample: FAQClick = {
        // TypeLink properties
    ...
    const filtersClickExample: FiltersClick = {
    ...
    const linkClickExample: LinkClick = {
        // TypeLink properties
    ...
    const liveChatClickExample: LiveChatClick = {
        // TypeLink properties
    ...
    const navigationLinkClickExample: NavigationLinkClick = {
        // TypeLink properties
    ...
    const topBannerClickExample: TopBannerClick = {
        // TypeLink properties
    ...
    console.log(categoryPageViewExample)
    console.log(checkoutPaymentPageViewExample)
    console.log(checkoutPurchaseCompletePageViewExample)
    console.log(checkoutShippingPageViewExample)
    console.log(exitLinkClickExample)
    console.log(homePageViewExample)
    console.log(orderReviewPageViewExample)
    console.log(pageViewExample)
    console.log(productDetailPageViewExample)
    console.log(purchaseExample)
    console.log(removeFromCartExample)  
    console.log(searchResultsPageViewExample)
    console.log(errExample)
    console.log(searchResultsClickExample)
    console.log(componentImpressionExample)
    console.log(emailSignupSuccessExample)
    console.log(faqClickExample)
    console.log(filtersClickExample)
    console.log(linkClickExample)
    console.log(liveChatClickExample)
    console.log(navigationLinkClickExample)
    console.log(topBannerClickExample)
